...
while ($siswa = mysqli_fetch_array($sql_query)) {
    ...
    echo '<td> <a class="btn btn-secondary btn-sm" href="register_edit.php?id='.$siswa['id'].'">Edit</a> <button class="btn btn-danger btn-sm "data-id='.$siswa['id'].'>Hapus</button> </td>';
    echo '</tr>';
}
?>
        </tbody>
